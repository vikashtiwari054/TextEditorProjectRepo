...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("text/editor/pack/icons/windows.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("text/editor/pack/icons/notepad.png"));
